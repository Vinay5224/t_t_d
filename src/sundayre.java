 ...
 * 
 * Description:
 * 			 This removes the particular document in the SundayCollection, by getting the ID from the 
 * SundayBusinessRule page (DarshanTimeEstimation.jsp).
 * 
 * @author G.MuniKumari
 *
 */
@WebServlet("/sundayre")
public class sundayre extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //parsing the string to the Integer
		...
		//removing that particular document in the SundayCollection

		sundaycollection.remove(ID);
