 ...
 * 
 * Description:
 * 			 This removes the particular document in the ThursdayCollection, by getting the ID from the 
 * ThursdayBusinessRule page (DarshanTimeEstimation.jsp).
 * 
 * @author G.MuniKumari
 *
 */
@WebServlet("/thursdayre")
public class thursdayre extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //parsing the string to the Integer
		...
		//removing that particular document in the ThursdayCollection

		thursdaycollection.remove(ID);
