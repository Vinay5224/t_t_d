 ...
 * 
 * Description:
 * 			 This removes the particular document in the WednesdayCollection, by getting the ID from the 
 * WednesdayBusinessRule page (DarshanTimeEstimation.jsp).
 * 
 * @author G.MuniKumari
 *
 */
@WebServlet("/wednesdayre")
public class wednesdayre extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //parsing the string to the Integer
		...
		//removing that particular document in the WednesdayCollection
		
		wednesdaycollection.remove(ID);
