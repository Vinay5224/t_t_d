 ...
 * 
 * Description:
 * 			 This removes the particular document in the SaturdayCollection, by getting the ID from the 
 * SaturdayBusinessRule page (DarshanTimeEstimation.jsp).
 * 
 * @author G.MuniKumari
 *
 */
@WebServlet("/saturdayre")
public class saturdayre extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //parsing the string to the Integer
		...
		//removing that particular document in the SaturdayCollection

		saturdaycollection.remove(ID);
