 ...
 * 
 * Description:
 * 			 This removes the particular document in the FridayCollection, by getting the ID from the 
 * FridayBusinessRule page (DarshanTimeEstimation.jsp).
 * 
 * @author G.MuniKumari
 *
 */
@WebServlet("/fridayre")
public class fridayre extends HttpServlet {
...
//Now connect to Database
		...
		//removing that particular document in the FridayCollection
		fridaycollection.remove(ID);
